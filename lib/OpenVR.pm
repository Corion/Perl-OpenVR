...
our %EXPORT_TAGS = ( 'all' => [ qw(
    ...
    EVRMouseButton_VRMouseButton_Left
    EVRMouseButton_VRMouseButton_Middle
...
sub AUTOLOAD {
    ...
    croak "&OpenVR::constant not defined" if $constname eq 'constant';
...
OpenVR - Perl extension for connecting to OpenVR devices
...
Stub documentation for OpenVR, created by h2xs. It looks like the
